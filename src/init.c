...
extern SEXP triebeard_greedy_integer(SEXP, SEXP);
extern SEXP triebeard_greedy_logical(SEXP, SEXP);
extern SEXP triebeard_greedy_numeric(SEXP, SEXP);
extern SEXP triebeard_greedy_string(SEXP, SEXP);
extern SEXP triebeard_longest_integer(SEXP, SEXP);
extern SEXP triebeard_longest_logical(SEXP, SEXP);
extern SEXP triebeard_longest_numeric(SEXP, SEXP);
extern SEXP triebeard_longest_string(SEXP, SEXP);
extern SEXP triebeard_prefix_integer(SEXP, SEXP);
extern SEXP triebeard_prefix_logical(SEXP, SEXP);
extern SEXP triebeard_prefix_numeric(SEXP, SEXP);
extern SEXP triebeard_prefix_string(SEXP, SEXP);
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"triebeard_greedy_integer",       (DL_FUNC) &triebeard_greedy_integer,       2},
    {"triebeard_greedy_logical",       (DL_FUNC) &triebeard_greedy_logical,       2},
    {"triebeard_greedy_numeric",       (DL_FUNC) &triebeard_greedy_numeric,       2},
    {"triebeard_greedy_string",        (DL_FUNC) &triebeard_greedy_string,        2},
    {"triebeard_longest_integer",      (DL_FUNC) &triebeard_longest_integer,      2},
    {"triebeard_longest_logical",      (DL_FUNC) &triebeard_longest_logical,      2},
    {"triebeard_longest_numeric",      (DL_FUNC) &triebeard_longest_numeric,      2},
    {"triebeard_longest_string",       (DL_FUNC) &triebeard_longest_string,       2},
    {"triebeard_prefix_integer",       (DL_FUNC) &triebeard_prefix_integer,       2},
    {"triebeard_prefix_logical",       (DL_FUNC) &triebeard_prefix_logical,       2},
    {"triebeard_prefix_numeric",       (DL_FUNC) &triebeard_prefix_numeric,       2},
    {"triebeard_prefix_string",        (DL_FUNC) &triebeard_prefix_string,        2},
